...
import url from 'assets/images/w4turl.png'
    ...
    const getUserData = () => {
      ...
      return new Promise((resolve, reject) => {
        api.collect([
          ...
          res.minBalance = BigNumber(res.totalSupply).div('1000').toFixed(4, BigNumber.ROUND_UP)
          res.updater = storage.get().loggingOut ? null : setTimeout(() => getUserData(), 60000)
